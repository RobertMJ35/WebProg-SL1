                    ...
                    <div class="row" style="margin-bottom: 25pt; align-items: center">
                        ...
                        <div class="col-8">
                            <input type="text" class="form-control" name="namaDepan" style="border: none; width:100%"
                                value="<?php if(isset($_SESSION["namaDepan"])){ echo $_SESSION["namaDepan"]; } else { echo ""; }?>">
                        </div>
                    </div>
                    <div class="row" style="margin-bottom: 25pt; align-items: center">
                    <div class="col-4">
                        ...
                        <div class="col-8">
                            <input type="text" class="form-control" name="tempatLahir" style="border: none; width:100%"
                                value="<?php if(isset($_SESSION["tempatLahir"])){ echo $_SESSION["tempatLahir"]; } else { echo ""; }?>">
                        </div>
                    </div>
                    <div class="row" style="margin-bottom: 25pt; align-items: center">
                    <div class="col-4">
                        ...
                        <div class="col-8">
                            <input type="text" class="form-control" name="wargaNegara" style="border: none; width:100%"
                                value="<?php if(isset($_SESSION["wargaNegara"])){ echo $_SESSION["wargaNegara"]; } else { echo ""; }?>">
                        </div>
                    </div>
                    <div class="row" style="margin-bottom: 25pt; align-items: center">
                    <div class="col-4">
                        ...
                        <div class="col-8">
                            <input type="textarea" class="form-control" name="alamat" style="border: none; width:100%; height: 90pt"
                                value="<?php if(isset($_SESSION["alamat"])){ echo $_SESSION["alamat"]; } else { echo ""; }?>">
                        </div>
                    </div>
                    <div class="row" style="margin-bottom: 25pt; align-items: center">
                    <div class="col-4">
                    ...
                    <div class="row" style="margin-bottom: 25pt; align-items: center">
                        ...
                        <div class="col-8">
                            <input type="text" class="form-control" name="namaTengah" style="border: none; width:100%"
                                value="<?php if(isset($_SESSION["namaTengah"])){ echo $_SESSION["namaTengah"]; } else { echo ""; }?>">
                        </div>
                    </div>
                    <div class="row" style="margin-bottom: 25pt; align-items: center">
                    <div class="col-4">
                        ...
                        <div class="col-8">
                            <input type="date" class="form-control" name="tglLahir" style="border: none; width:100%"
                                value="<?php if(isset($_SESSION["tglLahir"])){ echo $_SESSION["tglLahir"]; } else { echo ""; }?>">
                        </div>
                    </div>
                    <div class="row" style="margin-bottom: 25pt; align-items: center">
                    <div class="col-4">
                    ...
                    <div class="col-4">
                        ...
                        <div class="col-8">
                            <input type="number" class="form-control" name="kodePos" style="border: none; width:100%"
                                value="<?php if(isset($_SESSION["kodePos"])){ echo $_SESSION["kodePos"]; } else { echo ""; }?>">
                        </div>
                    </div>
                    <div class="row" style="margin-bottom: 25pt; align-items: center">
                    <div class="col-4">
                        ...
                        <div class="col-8">
                            <input type="password" class="form-control" name="password1" style="border: none; width:100%"
                                value="<?php if(isset($_SESSION["password1"])){ echo $_SESSION["password1"]; } else { echo ""; }?>">
                        </div>
                    </div>
                </div>
                    ...
                    <div class="row" style="margin-bottom: 25pt; align-items: center">
                        ...
                        <div class="col-8">
                            <input type="text" class="form-control" name="namaBelakang" style="border: none; width:100%"
                                value="<?php if(isset($_SESSION["namaBelakang"])){ echo $_SESSION["namaBelakang"]; } else { echo ""; }?>">
                        </div>
                    </div>
                    <div class="row" style="margin-bottom: 25pt; align-items: center">
                    <div class="col-4">
                        ...
                        <div class="col-8">
                            <input type="number" class="form-control" name="nik" style="border: none; width:100%"
                                value="<?php if(isset($_SESSION["nik"])){ echo $_SESSION["nik"]; } else { echo ""; }?>">
                        </div>
                    </div>
                    <div class="row" style="margin-bottom: 25pt; align-items: center">
                    <div class="col-4">
                        ...
                        <div class="col-8">
                            <input type="text" class="form-control" name="noHP" style="border: none; width:100%"
                                value="<?php if(isset($_SESSION["noHP"])){ echo $_SESSION["noHP"]; } else { echo ""; }?>">
                        </div>
                    </div>
                    <div class="row" style="margin-bottom: 90pt; align-items: center">
                    <div class="col-4">
                        ...
                        <div class="col-8">
                            <input type="file" class="form-control" name="foto" style="border: none; width:100%" accept="image/*">
                        </div>
                    </div>
                    <div class="row" style="margin-bottom: 25pt; align-items: center">
                    <div class="col-4">
                        ...
                        <div class="col-8">
                            <input type="password" class="form-control" name="password2" style="border: none; width:100%"
                                value="<?php if(isset($_SESSION["password2"])){ echo $_SESSION["password2"]; } else { echo ""; }?>">
                        </div>
                    </div>
                </div>
            </div>
