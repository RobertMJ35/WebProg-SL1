            ...
            <div class="col-6" style="background-color: #985EFF;
                ...
                <div class="row" style="margin-bottom: 20pt; align-items: center">
                    ...
                    <div class="col-9">
                        ...
                        value="<?php if(isset($_SESSION["usernameLogin"])){ echo $_SESSION["usernameLogin"]; } else { echo ""; }?>">
                    </div>
                </div>
                <div class="row" style="align-items: center">
                    ...
                    <div class="col-9">
                        <input type="password" class="form-control" name="passwordLogin" style="border: none; width:100%">
                    </div>
                </div>
